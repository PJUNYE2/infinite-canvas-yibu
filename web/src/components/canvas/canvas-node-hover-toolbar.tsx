...
export function CanvasNodeHoverToolbar({
    ...
    const nodeToolbarTools: ToolbarTool[] = [
        ...
        ...(canRetry ? [{ id: "retry", title: t(canResumeTask ? "canvas.nodeToolbar.resumeTaskTitle" : "canvas.nodeToolbar.retryTitle"), label: t(canResumeTask ? "canvas.node.resume" : "canvas.node.retry"), icon: <RefreshCw className="size-4" />, onClick: () => onRetry(node) }] : []),
