                            ...
                            <Form layout="vertical" requiredMark={false}>
                                ...
                                <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
                                    <div>
                                        ...
                                        <div className="mt-1 text-xs text-stone-500">按模型名称重新识别各渠道模型能力，不会在打开页面时自动覆盖。</div>
                                    </div>
                                    <Button icon={<RefreshCw className="size-4" />} onClick={autoDetectModels}>自动识别</Button>
                                </div>
