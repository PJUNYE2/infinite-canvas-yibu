export default {
    ...
    imageWorkbench: {
        ...
        continueQuery: "Continue query",
        regenerate: "Generate again",
        taskRecoverable: "{{message}}. Task ID: {{taskId}}",
        taskRecoverableShort: "The image task is still running. Wait 3–5 minutes, then query again. Task ID: {{taskId}}",
    },
    videoWorkbench: {
        title: "Video Studio",
    ...
    canvas: {
        ...
        nodeToolbar: { noPrompt: "No prompt to copy", infoTitle: "View node information", info: "Info", removeTitle: "Remove node", retryTitle: "Generate again", resumeTaskTitle: "Continue querying async task", saveAsset: "Save asset", downloadAudio: "Download audio", downloadVideo: "Download video", downloadImage: "Download image", editTextTitle: "Edit text", editText: "Edit text", decreaseFont: "Decrease font size", increaseFont: "Increase font size", zoomOut: "Smaller", zoomIn: "Larger", uploadImage: "Upload image", replaceVideo: "Replace video", uploadVideo: "Upload video", replaceAudio: "Replace audio", uploadAudio: "Upload audio", nodeInfo: "Node information", name: "Name", type: "Type", size: "Size", position: "Position", status: "Status", imageGroup: "Image group", imageSize: "Image size" },
    ...
    config: {
        ...
        preferences: {
            ...
            defaultModels: "Default models", autoDetect: "Auto-detect", autoDetectDescription: "Re-detect each channel model capability by name. This does not run automatically when the page opens.",
