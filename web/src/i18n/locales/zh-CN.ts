export default {
    ...
    imageWorkbench: {
        ...
        continueQuery: "继续查询",
        regenerate: "重新生成",
        taskRecoverable: "{{message}}。任务ID:{{taskId}}",
        taskRecoverableShort: "生图任务进行中，可等待3-5分钟后点击按钮查询图片。任务ID:{{taskId}}",
    },
    videoWorkbench: {
        title: "视频创作台",
    ...
    canvas: {
        ...
        generation: { interrupted: "页面刷新后生成已中断，请重新生成。", taskRecoverable: "生图任务进行中，可等待3-5分钟后点击按钮查询图片。任务ID:{{taskId}}", front: "正面视角", rotateRight: "向右旋转 {{angle}} 度", rotateLeft: "向左旋转 {{angle}} 度", level: "水平视角", topDown: "俯视 {{angle}} 度", lowAngle: "仰视 {{angle}} 度", angleLabel: "AI 多角度：{{horizontal}}，{{pitch}}，镜头距离 {{distance}}，{{lens}}镜头", anglePrompt: "基于参考图重新生成同一主体的新视角，保持主体、颜色、材质和画面风格一致，不要只做透视变形。{{angle}}。" },
    ...
    version: {
        viewUpdates: "查看版本更新",
        title: "版本更新", changelog: "更新日志", builtIn: "本地内置",
        currentVersion: "当前版本",
        latestVersion: "最新版本",
        checking: "检查中...",
        checkUpdates: "检查更新",
    ...
    config: {
        ...
        preferences: {
            ...
            defaultModels: "默认模型", autoDetect: "自动识别", autoDetectDescription: "按模型名称重新识别各渠道模型能力，不会在打开页面时自动覆盖。",
